...
class ImageMaskDatasetGenerator:
  ...
  def create_mask(self, dataset, output_dir, w, h, data_file, category, name):
    categories = {
       ...
       "Metaplastic":  (0,   255, 0),
       "Parabasal"  :  (255, 0,  128),
       "Superficial-Intermediate": (128, 0, 255),
    }
...
if __name__ == "__main__":
  try:
    root_dir   = "./Cervical-Cancer"
    output_dir = "./Cervical-Cancer-ImageMaskDataset-V2"
    ...
    generator = ImageMaskDatasetGenerator(data_dir="./", output_dir=output_dir, 
